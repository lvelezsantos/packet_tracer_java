 ...
 * @author warlock
 */
public class ConexionGuardar implements Serializable{
    private DispositivoGuardar dispositivo; // dispositivo al cual se conecta.
    ...
    public ConexionGuardar() {
    }

    
    
    public ConexionGuardar(
                    DispositivoGuardar dispositivo, 
                    String modulo_cad, 
                    String puerto_cad,
                    String modulo_local,
                    String puerto_local) {
    ...
    public DispositivoGuardar getDispositivo() {
        return dispositivo;
    }

    public void setDispositivo(DispositivoGuardar dispositivo) {
        this.dispositivo = dispositivo;
    }
